...
def get_embedder(is_local_ollama: bool = False, use_google_embedder: bool = False, embedder_type: str = None) -> adal.Embedder:
    ...
    Args:
        ...
        embedder_type: Direct specification of embedder type ('ollama', 'google', 'openai', 'mapiguru', 'voyage')
    ...
    if embedder_type:
        ...
        elif embedder_type == 'mapiguru':
            embedder_config = configs["embedder_mapiguru"]
